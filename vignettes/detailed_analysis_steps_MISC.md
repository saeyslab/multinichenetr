...
## #   *: prioritization_score, *: lr_interaction, *: scaled_LR_prod, *: scaled_LR_frac, *: scaled_LR_pb_prod, *: n_cells_receiver, *: keep_receiver, *: n_cells_sender, *: keep_sender, *: keep_sender_receiver
```
...
## 10 S     L_NK_CD56._CD16.        M_Monocyte_CD14_resting TGFB1   ENG      TGFB1_ENG_L_NK_CD56._CD16._M_Monocyte_CD14_resting                         0.940                  10
```
