...
The Nichenet v2 networks and matrices for both mouse and human can be downloaded from Zenodo [![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.5884439.svg)](https://doi.org/10.5281/zenodo.5884439). 
...
P-value histograms of both the normal and empirical p-values look good here. In case the normal p-value distributions don't look good, we recommend to continue based on the empirical p-values. 
