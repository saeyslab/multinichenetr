...
__User adaptation required__
```{r, fig.width=7, fig.height=7}
DE_info_emp$z_distr_plots_emp_pval$`CAF.High-Low`
DE_info_emp$z_distr_plots_emp_pval$`Malignant.High-Low`
DE_info_emp$z_distr_plots_emp_pval$`myofibroblast.High-Low`
```
