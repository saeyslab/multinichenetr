...
__User adaptation required__
```{r, fig.width=7, fig.height=7}
DE_info_emp_sender$z_distr_plots_emp_pval$`CAF.High-(Medium+Low)/2`
DE_info_emp_sender$z_distr_plots_emp_pval$`myofibroblast.High-(Medium+Low)/2`
DE_info_emp_receiver$z_distr_plots_emp_pval$`Malignant.High-(Medium+Low)/2`
# also recommended to check the other plots...
```
