...
In this vignette, you can learn how to perform an all-vs-all MultiNicheNet analysis. In this vignette, we start from two SingleCellExperiment objects: one SingleCellExperiment object containing the sender cell types, and one SingleCellExperiment object with receiver cell types. (for demonstration purposes, we start from the same object, that we then split based on sender/receiver cell type)
...
make_target_violin_plot(sce_receiver = sce_receiver, target_oi = target_oi, receiver_oi = receiver_oi, group_oi = group_oi, group_id = group_id, sample_id, celltype_id_receiver = celltype_id_receiver, multinichenet_output$prioritization_tables$group_prioritization_tbl)
make_target_nebulosa_feature_plot(sce_receiver = sce_receiver, target_oi = target_oi, group_oi = group_oi, group_id = group_id, celltype_id_receiver = celltype_id_receiver, receivers_oi = c("Malignant"), multinichenet_output$prioritization_tables$group_prioritization_tbl) 
