...
* [Multi-sample Multi-condition Cell-Cell Communication Analysis via NicheNet: HNSCC application; Separate: step-by-step (recommended)](vignettes/basic_analysis_separate_steps.md): `vignette("basic_analysis_separate_steps", package="multinichenetr")`
